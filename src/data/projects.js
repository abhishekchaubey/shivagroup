export const projectsData = [
  {
    id: "residential",
    title: "Manduadih Residential Project",
    category: "Residential",
    description: "A premium Vastu-based residential complex with modern amenities, designed for contemporary living while respecting traditional principles.",
    location: "Manduadih, Varanasi",
  ...
  {
    id: "commercial",
    title: "Hathi Bazar Complex",
    category: "Commercial",
    description: "A state-of-the-art commercial building designed for maximum utility and aesthetic appeal in a bustling market area.",
    location: "Hathi Bazar, Varanasi",
  ...
  {
    id: "industrial",
    title: "Hindustan Unilever Warehouse",
    category: "Industrial",
    description: "Large scale industrial building at Ramnagar Varanasi, optimized for logistics, storage, and efficient workflow management.",
  ...
  {
    id: "interior",
    title: "Ashoak Vastralay Interior",
    category: "Interior Design",
    description: "Modern interior redesign for a premium retail experience, focusing on lighting, space utilization, and brand identity.",
